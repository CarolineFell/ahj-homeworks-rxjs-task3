...
import { startWith, scan, share, pluck, distinctUntilChanged } from 'rxjs/operators';
import DOM from './DOM';
...
dom.drawStats(objProjects.projects, dashboard);
dom.addTasks(objProjects.projects, dashboard);
